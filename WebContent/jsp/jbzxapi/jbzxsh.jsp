...
<div class="admin-content nav-tabs-custom box">
	...
	商户征信订单审核  人行征信简版管理详情来自：${requestScope.gname }-${requestScope.pname }-${fn:substring(requestScope.jbzx.dt_edit, 0,19)}
		<input name="adminop_tag" value="0" type="hidden">
		<div class="box-body">
			<div class="form-group"><label class="col-sm-2 control-label">被查询人信息</label>
				<div class="col-sm-10">
					<div class="row inline-from">
						<div class="col-sm-4">
							<div class="input-group"><span class="input-group-addon">姓名</span> <input class="form-control" name="c_name" id="c_name" value="${requestScope.jbzx.c_name }" type="text"></div>
					</div>
						<div class="col-sm-4">
							<div class="input-group"><span class="input-group-addon">身份证</span> <input class="form-control" name="c_cardno" id="c_cardno" value="${requestScope.jbzx.c_cardno }" type="text"></div>
					</div>
						<div class="col-sm-4">
							<div class="input-group"><span class="input-group-addon">电话</span> <input class="form-control" name="c_tel" id="c_tel" value="${requestScope.jbzx.c_tel }" type="text"></div>
					</div>
						<div class="col-sm-12">
							<div class="input-group"><span class="input-group-addon">api_message</span><input class="form-control" name="api_resultmsg" id="api_resultmsg" value="${requestScope.jbzx.api_resultmsg }" type="text"></div>
					</div>
				</div>
			</div></div>
	</div>
		<div class="box-header with-border">
			...
			<div class="form-group"><label class="col-sm-2 control-label">报告详情</label>
				<div class="col-sm-10">${requestScope.jbzx.api_resultmsg }</div>
			            </div>
	</div>
				<div class="box-header with-border">
						...
						<div class="col-sm-6">
							...
							<span class="input-group-addon">审核状态</span>
							 <select name="bc_status" class="form-control" id="bc_status" onchange="autoremark();">
                            	<option value="1" ${jbzx.bc_status==1?"selected='selected'":''}>草稿箱</option>
                            	<option value="2" ${jbzx.bc_status==2?"selected='selected'":''}>正在查询</option>
                            	<option value="3" ${jbzx.bc_status==3?"selected='selected'":''}>查询完成</option>
                            	<option value="4" ${jbzx.bc_status==4?"selected='selected'":''} >回退</option>
                            	<option value="5" ${jbzx.bc_status==5?"selected='selected'":''}>已撤销</option>                            
                            	</select>
                            	</div>
					</div>
						<div class="col-sm-6">
 ...
 <input class="form-control" readonly="readonly" value="人行征信简版管理" type="text"></div>
					</div>
				</div>
			</div></div>
...
<c:forEach items="${requestScope.jbzxhistory }" var="jh">
${fn:substring(jh.addtime, 0,19)}：类型：${jh.apitype }：留言：${jh.msg }                
</c:forEach>
</textarea>
</div></div>		
</div>
	...
	$.post("ajax.php?do=doocrdr",{fid:12,type:xtype},function(res){
		...
		if(res.status==0 || res.status=='OK'){
			...
			<div class="box-footer">
				<button type="button" class="btn btn-default" onclick="window.location.href='jbzxlist.do'">取消返回</button>
