...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	...
	<meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
	 ...
	 <script type="text/javascript">
		...
		var page_cn = "assess_mgcar";
	</script>
	
	<!-- Bootstrap 3.3.4 -->
	<link href="kjs_css/bootstrap.css" rel="stylesheet" type="text/css">
	<!-- Font Awesome Icons -->
	<!-- Font Awesome Icons -->
	<link href="kjs_css/font-awesome.css" rel="stylesheet" type="text/css">
	<link href="kjs_css/font-awesome.min.css" rel="stylesheet" type="text/css">
	
	<link href="kjs_css/select2.css" rel="stylesheet" type="text/css">
	
	
	<!-- Theme style -->
	<link href="kjs_css/AdminLTE.css" rel="stylesheet" type="text/css">
	<!-- AdminLTE Skins. We have chosen the skin-blue for this starter
			page. However, you can choose any other skin. Make sure you
			apply the skin class to the body tag so the changes take effect.
	-->
	<link href="kjs_css/skin-green.css" rel="stylesheet" type="text/css">
	<link href="kjs_css/style.css" rel="stylesheet" type="text/css">
   <script src="kjs_css/jQuery-2.1.4.min.js" type="text/javascript"></script>
	<script src="kjs_css/jquery.form.js" type="text/javascript"></script>
	...
	<!-- jQuery 2.1.4 -->
	<script src="kjs_css/jQuery-2.js" type="text/javascript"></script>
	<script src="kjs_css/common.js" type="text/javascript"></script>
	<script src="kjs_css/jquery.js" type="text/javascript"></script>
	<script src="kjs_css/ajaxfileupload.js" type="text/javascript"></script>
	<script type="text/javascript" src="kjs_css/php.js"></script>
    
	<!-- Bootstrap 3.3.2 JS -->
	<script src="kjs_css/bootstrap.js" type="text/javascript"></script>
	
	<script src="kjs_css/moment.js" type="text/javascript"></script>
	<script src="kjs_css/daterangepicker.js" type="text/javascript"></script>
	<link href="kjs_css/daterangepicker-bs3.css" rel="stylesheet" type="text/css">
	
	<script src="kjs_css/bootstrap-datepicker.js" type="text/javascript"></script>
	<link href="kjs_css/datepicker3.css" rel="stylesheet" type="text/css">
	<script src="kjs_css/bootstrap-datepicker_002.js" type="text/javascript"></script>
	
	<script src="kjs_css/bootstrap-datetimepicker.js" type="text/javascript"></script>
	<link href="kjs_css/bootstrap-datetimepicker.css" rel="stylesheet" type="text/css">
	<script src="kjs_css/bootstrap-datetimepicker_002.js" type="text/javascript"></script>
	
	
	<script type="text/javascript" charset="utf-8" src="kjs_css/ueditor_002.js"></script>
	<script type="text/javascript" charset="utf-8" src="kjs_css/ueditor.js"> </script>
	<!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
	<!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
	<script type="text/javascript" charset="utf-8" src="kjs_css/zh-CN.js"></script>
	
	
	
	<script src="kjs_css/select2.js" type="text/javascript"></script>
	<script src="kjs_css/zh-CN.js" type="text/javascript"></script>
	<script src="kjs_css/zh-cn.js" type="text/javascript"></script>
		
	<!-- AdminLTE App -->
	<script src="kjs_css/app.js" type="text/javascript"></script>
	 
	<script src="kjs_css/combo.js" type="text/javascript"></script>
	<script src="kjs_css/imgup.js" type="text/javascript"></script>
	<link href="kjs_css/imgup.css" rel="stylesheet" type="text/css">
	<!-- <script src="/comm/jquery.dragsort-0.4.min.js" type="text/javascript"></script> -->
	
	<link href="kjs_css/iconfont.css" rel="stylesheet" type="text/css">
	</head>
	<!--
	BODY TAG OPTIONS:
	=================
...
<section class="content-header">
		...
		<section class="content">
			...
			<div class="admin-tools">
				<div class="row">
					...
					var pagesize=$("#page_limit_select").val();						
					//alert(type+"--"+status+"--"+pagesize);
					window.location.href='icbclist.do?bc_status='+status+'&pagesize='+pagesize;
					}
					</script>
					<div class="col-sm-2 admin-page-top hidden-xs">					        
					        <input value="${requestScope.bc_status }" id="status" name="status" type="hidden">
							<select id="page_limit_select" onchange="changepage()" class="form-control">
	...
	<tbody>
		<tr>
			...
			<th>编号</th>
			<th class="hidden-xs " style="width:500px">公司名|姓名</th>
			<th class="text-center" style="width:300px">借款人</th>
			<th class="text-center" style="width:300px">添加时间</th>
			<th style="width: 80px" class="text-center">操作</th>
			<th class="text-center hidden-xs" style="width: 200px">银联代收代付</th>			
			<th style="width: 80px">当前状态</th>
		</tr>
		<c:forEach items="${requestScope.list }" var="mgcert">
			<tr>
			<td class="text-center"><input name="delid" value="113" type="checkbox"></td>
			<td >${mgcert.gems_code }</td>
			<td class="hidden-xs ">来源:${mgcert.gname }-${mgcert.pname }</td>
			<td class="hidden-xs text-center">${mgcert.c_name }</td>
			<td class="hidden-xs text-center">${fn:substring(mgcert.dt_add, 0,19)}</td>
			<td class="text-center">
				<!--  编辑-->
			<div class="table-button">
			<a href="icbcytoexamine.do?id=${mgcert.id }&bc_status=${requestScope.bc_status}&gname=${mgcert.gname}&pname=${mgcert.pname}" class="btn btn-default">
			<i class="fa fa-pencil"></i></a>
			</div>
			</td>
			<td class="text-center hidden-xs">
					<!--  签约--> 
					<a data-toggle="modal" style="" data-target="#modal" href="icbcyl.do?type=1&name=${mgcert.c_name }&cardid=${mgcert.c_cardno}" class="btn btn-default">
			...
			<td><!--当前状态  -->
			<c:if test="${mgcert.bc_status eq '1'}">
			<span class="label label-warning">草稿箱</span>
			</c:if>			
			<c:if test="${mgcert.bc_status eq '2'}">
			<span class="label label-warning">待审核</span>
			</c:if>
			<c:if test="${mgcert.bc_status eq '3'}">
			<span class="label label-success">初审通过，请补件</span>
			</c:if>
			<c:if test="${mgcert.bc_status eq '4'}">
			<span class="label label-success">补件完成，提交审核</span>
			</c:if>
			<c:if test="${mgcert.bc_status eq '5'}">
			<span class="label label-success">完成-通过</span>
			</c:if>
			<c:if test="${mgcert.bc_status eq '6'}">
			<span class="label label-success">完成-失败</span>
			</c:if>
			<c:if test="${mgcert.bc_status eq '7'}">
			<span class="label label-success">回退</span>
				...
				<ul id="page" class="pagination no-margin">
				       <c:if test="${requestScope.now ne '1' }">
				       <li >
				       <a  href="icbclist.do?bc_status=${requestScope.bc_status }&pagesize=${requestScope.size }&pagenow=${requestScope.now-1}">
				       <span >«</span>
				       </a>
				       </li>
				       </c:if>
				       <%
				       int pagenow=Integer.parseInt(request.getAttribute("now").toString());
					   ...
					   <a id="a<%=j %>" href="icbclist.do?bc_status=${requestScope.bc_status }&pagesize=${requestScope.size }&pagenow=<%=j %>">
					   <%=j %>
					   </a>
					   </li>
					   <%
					   ...
					   %>
	                   <li id="l<%=j %>" >
					   <a id="a<%=j %>" href="icbclist.do?bc_status=${requestScope.bc_status }&pagesize=${requestScope.size }&pagenow=<%=j %>"><%=j %>					   
					   </a>
					   </li>					   
		               <%
				       }
		               ...
		               %>
		               <c:if test="${requestScope.now lt requestScope.totalpage}">
		...
		<script type="text/javascript" src="kjs_css/list.js"></script>		
				<!-- 搜索层 -->
...
<input name="type" value="assess" type="hidden"><input name="cn" value="assess_mgcar" type="hidden"><input name="l" value="15" type="hidden"><input name="nav" value="0" type="hidden">			</form>
		</div>
