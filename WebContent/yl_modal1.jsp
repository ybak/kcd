...
<input name="gems_fs_id" value="64" type="hidden">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			...
			<option value="HKD">港元</option><option value="USD">美元</option>
			</select>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-9">
			...
			<option value="00" selected="selected">银行卡</option>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input class="form-control" name="ACCOUNT_NO" onkeyup="(this.v=function(){this.value=this.value.trim();this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();" type="text">
		</div>
	</div>
	<div class="form-group">
		<label for="title2" class="col-sm-3 control-label">持有人姓名</label>
		<div class="col-sm-9">
			<input class="form-control" name="ACCOUNT_NAME" onblur="this.value=this.value.trim();" value="${requestScope.name }" type="text">
		</div>
	</div>
	<div class="form-group">
		<label for="title2" class="col-sm-3 control-label">开户行所在省</label>
		<div class="col-sm-9">
			<input class="form-control" name="PROVINCE" onblur="this.value=this.value.trim();" type="text">
		</div>
	</div>
	<div class="form-group">
		<label for="title2" class="col-sm-3 control-label">开户行所在市</label>
		<div class="col-sm-9">
			<input class="form-control" name="CITY" onblur="this.value=this.value.trim();" type="text">
		</div>
	</div>
	<div class="form-group">
		<label for="title2" class="col-sm-3 control-label">开户行名称</label>
		<div class="col-sm-9">
			<input class="form-control" name="BANK_NAME" onblur="this.value=this.value.trim();" type="text">
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-9">
			...
			<option value="0" selected="selected">私人</option><option value="1">公司</option>			</select>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-9">
			...
			<option value="0" selected="selected">身份证</option><option value="1">户口簿</option><option value="2">护照</option><option value="3">军官证</option><option value="4">士兵证</option><option value="5">港澳居民来往内地通行证</option><option value="6">台湾同胞来往内地通行证</option><option value="7">临时身份证</option><option value="8">外国人居留证</option><option value="9">警官证</option><option value="X">其他证件</option>			</select>
		</div>
	</div>
	<div class="form-group">
		<label for="title2" class="col-sm-3 control-label">证件号码</label>
		<div class="col-sm-9">
			<input class="form-control" name="c_cardid" onblur="this.value=this.value.toUpperCase();this.value=this.value.trim();" value="${requestScope.cardid }" type="text">
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input class="form-control" name="TEL" onblur="this.value=this.value.toUpperCase();this.value=this.value.trim();" type="text">
	...
	<div class="form-group">
		...
		<div class="col-sm-9"><textarea style="width: 100%; height: 40px" class="form-control" name="remark"></textarea>
		</div>
	</div>
</div>
<script>
