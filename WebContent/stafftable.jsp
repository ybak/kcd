...
<!-- 	<body class="skin-green sidebar-mini fixed"> -->
			...
			<div class="admin-tools">
				<div class="row">
					...
					<div class="col-sm-5 admin-page-top hidden-xs">
							<select id="page_limit_select" onchange="" class="form-control">
	...
	<!-- 		<th style="width: 3%" class="text-center hidden-xs"><input type="checkbox" class="check_all"></th> -->
			...
			<th class="hidden-xs" style="width: 180px">公司（门店）名称</th>
			<th class="hidden-xs" style="width: 80px">账户等级</th>
			<th class="hidden-xs" style="width: 80px">员工姓名</th>
			<th class="hidden-xs" style="width: 80px">帐号</th>
			...
			<td class="hidden-xs">1级</td>
			<td class="hidden-xs">张三</td>
			<td class="hidden-xs">a11111</td>
...
<script>
	...
	<!-- 			<li><a href="" aria-label="Next"><span aria-hidden="true"></span></a>
				...
				<div class="page-num">共1094个 分110页显示</div>
				<div class="table-button">
				<a href="companytable.jsp" class="btn btn-default"><i class="fa fa-reply-all"></i> 返回</a>
				</div>
			</div>
					</section><!-- /.content -->
		</body>
