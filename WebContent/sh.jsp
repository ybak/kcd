...
<style>.m-input-select{color:black;width:100%;display:inline-block;*display:inline;position:relative;-webkit-user-select:none;}.m-input-select ul, .m-input-select li{padding:0;margin:0;color:black;}n.m-input-select .m-input{padding-right:22px;color:black;}.m-input-select .m-input-ico{position:absolute;right:0;top:0;width:22px;height:100%;background:url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMCAYAAABWdVznAAAATElEQVQoU2NkIBEwkqiegTwNcXFx/4m1CW4DMZoWLVrEiOIkfJpAikGuwPADNk0wxVg1gASRNSErxqkBpgldMV4NuEKNvHggNg5A6gBo4xYmyyXcLAAAAABJRU5ErkJggg==) no-repeat 50% 50%;}.m-input-select .m-list-wrapper{}.m-input-select .m-list{display:none;position:absolute;z-index:9;top:100%;left:0;right:0;max-width:100%;max-height:500px;overflow:auto;border-bottom:1px solid #ddd;}.m-input-select .m-list-item{cursor:default;padding:5px;margin-top:-1px;list-style:none;background:#fff;color:black;border:1px solid #ddd;border-bottom:none;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}.m-input-select .m-list-item:hover{background:#2D95FF;}.m-input-select .m-list-item-active{background:#2D95FF;}</style>
	...
	<!-- Bootstrap 3.3.4 -->
	<link href="./sh/bootstrap.css" rel="stylesheet" type="text/css">
	<!-- Font Awesome Icons -->
	<!-- Font Awesome Icons -->
	<link href="./sh/font-awesome.css" rel="stylesheet" type="text/css">
	
	<link href="./sh/select2.css" rel="stylesheet" type="text/css">
	
	
	<!-- Theme style -->
	<link href="./sh/AdminLTE.css" rel="stylesheet" type="text/css">
	<!-- AdminLTE Skins. We have chosen the skin-blue for this starter
			page. However, you can choose any other skin. Make sure you
			apply the skin class to the body tag so the changes take effect.
	-->
	<link href="./sh/skin-green.css" rel="stylesheet" type="text/css">
	<link href="./sh/style.css" rel="stylesheet" type="text/css">
...
.footer-wrap.box-footer {
	...
	<!-- jQuery 2.1.4 -->
	<script src="./sh/jQuery-2.js" type="text/javascript"></script>
	<script src="./sh/common.js" type="text/javascript"></script>
	<script src="./sh/jquery.js" type="text/javascript"></script>
	<script src="./sh/ajaxfileupload.js" type="text/javascript"></script>
	<script type="text/javascript" src="./sh/php.js"></script>

	<!-- Bootstrap 3.3.2 JS -->
	<script src="./sh/bootstrap.js" type="text/javascript"></script>	
	<script src="./sh/moment.js" type="text/javascript"></script>
	<script src="./sh/daterangepicker.js" type="text/javascript"></script>
	<link href="./sh/daterangepicker-bs3.css" rel="stylesheet" type="text/css">	
	<script src="./sh/bootstrap-datepicker.js" type="text/javascript"></script>
	<link href="./sh/datepicker3.css" rel="stylesheet" type="text/css">
	<script src="./sh/bootstrap-datepicker_002.js" type="text/javascript"></script>	
	<script src="./sh/bootstrap-datetimepicker.js" type="text/javascript"></script>
	<link href="./sh/bootstrap-datetimepicker.css" rel="stylesheet" type="text/css">
	<script src="./sh/bootstrap-datetimepicker_002.js" type="text/javascript"></script>
	<script type="text/javascript" src="./js/ajaxfileupload.js"></script>
	<script type="text/javascript" charset="utf-8" src="./sh/ueditor_002.js"></script>
	<script type="text/javascript" charset="utf-8" src="./sh/ueditor.js"> </script>
	<!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
	<!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
	<script src="./sh/select2.js" type="text/javascript"></script>
	<script src="./sh/zh-CN.js" type="text/javascript"></script>			
	<!-- AdminLTE App -->
	<script src="./sh/app.js" type="text/javascript"></script>
	<script src="./sh/combo.js" type="text/javascript"></script>
	<script src="./sh/imgup.js" type="text/javascript"></script>
	<link href="./sh/imgup.css" rel="stylesheet" type="text/css">
	<!-- <script src="/comm/jquery.dragsort-0.4.min.js" type="text/javascript"></script> -->	
	<link href="./sh/iconfont.css" rel="stylesheet" type="text/css">
 <script src="./cjjs/jquery.min.js"></script>
  <script src="./cjjs/jquery.Jcrop.js"></script>
  <link rel="stylesheet" href="<%= request.getContextPath()%>/ccss/jquery.Jcrop.css" type="text/css" />
    <script type="text/javascript">  
        var current = 0;  
        function turnLeft(){  
...
$(document).ready(function(){	
	//alert(id);
	var href=document.getElementById("lblresult_pdf").href;
	//alert(href);

		$.post("filesize.do",{url:href},function(res){
			var res =eval("(" + res + ")");
				var num=res.fl;
				if(num!=0){
				var size=num/1024/1024;
			     document.getElementById("lblresult_pdf").text="查看(文件大小:"+size.toFixed(2)+"MB)";
				//$("#lblresult_pdf").text('查看(文件大小:'+num.toFixed(2)+'MB)');
				}else{
				 document.getElementById("lblresult_pdf").text="查看(文件大小:0.00MB)";		
					//document.getElementById("lblresult_pdf").href="javascript:void(0)";	
				}				
		});
	 test();
});	
...
<form id="info_form" action="tjxx.do" class="form-horizontal" method="post" enctype="multipart/form-data" >		
...
<div class="admin-content nav-tabs-custom box">
	...
	API征信订单审核  来自：${requestScope.gsname }-${requestScope.ryname }-${fn:substring(map.add_time, 0,19)}授权书分类-快车道
					...
					<div class="row inline-from">
						<div class="col-sm-6">
							<div class="input-group">
								...
								<input class="form-control" name="c_book_no" id="c_book_no" value="${requestScope.map.authorize_num }" type="text"><span class="input-group-addon">
								<a href="javascript:dozbar();">验证</a></span>
							</div>
						</div>
						<div class="col-sm-3">
							<div class="input-group">
								<span class="input-group-addon">姓名</span> 
								<input class="form-control" name="c_name" id="c_name" value="${requestScope.map.name }" type="text">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="input-group">
								<span class="input-group-addon">民族</span> 
								<input class="form-control" name="c_nation" id="c_nation" value="${requestScope.map.c_nation }" type="text">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="input-group">
								<span class="input-group-addon">地址</span>
								 <input class="form-control" name="c_address" id="c_address" value="${requestScope.map.c_address }" type="text">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="input-group">
								<span class="input-group-addon">身份证号码</span> 
								<input class="form-control" name="c_card_no" id="c_card_no" value="${requestScope.map.IDcard_num }" type="text">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="input-group">
								<span class="input-group-addon">身份证有效期</span> 
								<input class="form-control" name="c_card_outdate" value="${requestScope.map.c_card_outdate }" id="c_card_outdate" type="text">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="input-group">
								<span class="input-group-addon">身份证发证机关</span> 
								<input class="form-control" name="c_card_office" value="${requestScope.map.c_card_office }" id="c_card_office" type="text">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="input-group">
								<span class="input-group-addon">电话</span> 
								<input class="form-control" name="c_tel" id="c_tel" value="${requestScope.map.phone_num }" type="text" />
							</div>
						</div>
						<div class="col-sm-4">
							<div class="input-group">
								<span class="input-group-addon">证件类型</span> 
								<input class="form-control" name="c_card_type" id="c_card_type" value="${requestScope.map.c_card_type }" type="text">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="input-group">
								<span class="input-group-addon">性别</span> 
								<input class="form-control" name="c_sex" id="c_sex" value="${requestScope.map.c_sex }" type="text">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="input-group">
								<span class="input-group-addon">查询板式</span> 
								<input class="form-control" name="c_bs" id="c_bs" value="${requestScope.map.c_bs }" type="text">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="input-group">
								<span class="input-group-addon">曾用名</span> 
								<input class="form-control" name="c_oldname" id="c_oldname" value="${requestScope.map.c_oldname }" type="text">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="input-group">
								<span class="input-group-addon">通讯地址编码</span> 
								<input class="form-control" name="c_yb" id="c_yb" value="${requestScope.map.c_yb }" type="text" />
							</div>
						</div>
					</div>
				</div>
		...
		<div class="box-header with-border">
			<h3 class="box-title">审核功能区</h3>
			<a href="javascript:dodownall();" class="btn btn-success" style="margin-left: 5px">一键下载图片(1)</a>
			<a href="javascript:doocrsfz(1);doocrsfz(2);" class="btn btn-success" style="margin-left: 5px">识别身份证(2)</a>
			<a href="javascript:$('#c_book_no_black').val($('#c_book_no').val());" class="btn btn-success" style="margin-left: 5px; color: white; background: black;">授权书加入黑名单(3)</a>
			<a href="javascript:dozbar();" class="btn btn-success" style="margin-left: 5px;" id="booka">授权书编号验证(4)</a>
			<a data-toggle="modal" data-target="#mymodal" class="btn btn-warning" style="margin-left: 5px" href="http://a.kcway.net/assess/manager/float.php?bc_tag=-1&amp;nav=0&amp;query_type=0&amp;id=24668&amp;readonly=1&amp;type=crop&amp;ds_type=1&amp;cn=crop_zx&amp;qryid=24668&amp;do=view&amp;id=24668">图片在线初审</a>
		</div>
		<script type="text/javascript">
		...
		<div class="box-body">
			<div class="form-group">
				<div class="col-sm-12">
					<div class="row inline-from">					
					<c:choose>
					<c:when test="${requestScope.map.front eq '2'}">
					<div class="col-sm-2" style="width: 20%;">
							<div class="input-group">
								<img id="result_imgurl1_view" name="result_imgurl1_view" data-ri="0" data-src="" style="width: 220px; height: 150px;" src="./image/upload/img/${requestScope.tpath}/${requestScope.imgmap.frontimg }.new.jpg">
								<div style="padding-top: 5px">
								      <input type="hidden" id="i1" name="i1" value="${requestScope.tpath}/${requestScope.imgmap.frontimg }.new.jpg" /> 								      
									<a style="padding: 0px 5px;" class="btn btn-warning" id="ashowpic1" href="${requestScope.imgmap.httppath}/${requestScope.imgmap.frontimg }.new.jpg" target="_blank">查看</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:downallfile('1');">下载</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.frontimg }.new.jpg','${requestScope.tpath}',2,1);">右转</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.frontimg }.new.jpg','${requestScope.tpath}',1,1);">左转</a>
									<a data-toggle="modal" style="padding: 0px 5px;" data-target="#modal" class="btn btn-warning" href="javascript:cjimg(1);" onclick="cjimg(1,'${requestScope.imgmap.frontimg }.new.jpg')">裁剪</a>
								</div>
							</div>
						</div> 
					</c:when>					
					...
					<div class="col-sm-2" style="width: 20%;">
							<div class="input-group">
								<img id="result_imgurl1_view" name="result_imgurl1_view" data-ri="0" data-src="" style="width: 220px; height: 150px;" src="./image/upload/img/${requestScope.tpath}/${requestScope.imgmap.frontimg }">
								<div style="padding-top: 5px">
								    <input type="hidden" id="i1" name="i1" value="${requestScope.tpath}/${requestScope.imgmap.frontimg }" />
									<a style="padding: 0px 5px;" class="btn btn-warning" id="ashowpic1" href="${requestScope.imgmap.httppath}/${requestScope.imgmap.frontimg }" target="_blank">查看</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:downallfile('1');">下载</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.frontimg }','${requestScope.tpath}',2,1);">右转</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.frontimg }','${requestScope.tpath}',1,1);">左转</a>
									<a data-toggle="modal" style="padding: 0px 5px;" data-target="#modal" class="btn btn-warning" href="javascript:cjimg(1);" onclick="cjimg(1,'${requestScope.imgmap.frontimg }')">裁剪</a>
								</div>
							</div>
						</div> 
									...
									<c:choose>
									<c:when test="${requestScope.map.opposite eq '2'}">
																		<div class="col-sm-2" style="width: 20%;">
							<div class="input-group">
								<img id="result_imgurl2_view" name="result_imgurl2_view" data-ri="0" data-src="" style="width: 220px; height: 150px;" src="./image/upload/img/${requestScope.tpath}/${requestScope.imgmap.oppositeimg }.new.jpg">
								<div style="padding-top: 5px">
								<input type="hidden" id="i2" name="i2" value="${requestScope.tpath}/${requestScope.imgmap.oppositeimg }.new.jpg" />
									<a style="padding: 0px 5px;" class="btn btn-warning" id="ashowpic2" href="${requestScope.imgmap.httppath}/${requestScope.imgmap.oppositeimg }.new.jpg" target="_blank">查看</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:downallfile('2');">下载</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.oppositeimg }.new.jpg','${requestScope.tpath}',2,2);">右转</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.oppositeimg }.new.jpg','${requestScope.tpath}',1,2);">左转</a>
									<a data-toggle="modal" style="padding: 0px 5px;" data-target="#modal" class="btn btn-warning" href="javascript:cjimg(2);" onclick="cjimg(2,'${requestScope.imgmap.oppositeimg }.new.jpg')">裁剪</a>
								</div>
							</div>
						</div> 
									</c:when>
									<c:otherwise>
																		<div class="col-sm-2" style="width: 20%;">
							<div class="input-group">
								<img id="result_imgurl2_view" name="result_imgurl2_view" data-ri="0" data-src="" style="width: 220px; height: 150px;" src="./image/upload/img/${requestScope.tpath}/${requestScope.imgmap.oppositeimg }">
								<div style="padding-top: 5px">
								    <input type="hidden" id="i2" name="i2" value="${requestScope.tpath}/${requestScope.imgmap.oppositeimg }" />
									<a style="padding: 0px 5px;" class="btn btn-warning" id="ashowpic2" href="${requestScope.imgmap.httppath}/${requestScope.imgmap.oppositeimg }" target="_blank">查看</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:downallfile('2');">下载</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.oppositeimg }','${requestScope.tpath}',2,2);">右转</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.oppositeimg }','${requestScope.tpath}',1,2);">左转</a>
									<a data-toggle="modal" style="padding: 0px 5px;" data-target="#modal" class="btn btn-warning" href="javascript:cjimg(2);" onclick="cjimg(2,'${requestScope.imgmap.oppositeimg }')">裁剪</a>
								</div>
							</div>
						</div> 
									</c:otherwise>
							...
							<c:choose>
							<c:when test="${requestScope.map.apply eq '2'}">
								
														<div class="col-sm-2" style="width: 20%;">
							<div class="input-group">
								<img id="result_imgurl3_view" name="result_imgurl3_view" data-ri="0" data-src="${requestScope.imgmap.httppath}/${requestScope.imgmap.applyimg }.new.jpg" style="width: 220px; height: 150px;" src="./image/upload/img/${requestScope.tpath}/${requestScope.imgmap.applyimg }.new.jpg">
								<div style="padding-top: 5px">
									<a style="padding: 0px 5px;" class="btn btn-warning" id="ashowpic3" href="${requestScope.imgmap.httppath}/${requestScope.imgmap.applyimg }.new.jpg" target="_blank">查看</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:downallfile('3');">下载</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.applyimg }.new.jpg','${requestScope.tpath}',2,3);">右转</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.applyimg }.new.jpg','${requestScope.tpath}',1,3);">左转</a>
									<a data-toggle="modal" style="padding: 0px 5px;" data-target="#modal" class="btn btn-warning" href="javascript:cjimg(3);" onclick="cjimg(3,'${requestScope.imgmap.applyimg }.new.jpg')">裁剪</a>
								</div>
							</div>
						</div> 
							</c:when>
							<c:otherwise>
														...
														<div class="col-sm-2" style="width: 20%;">
							<div class="input-group">
								<img id="result_imgurl3_view" name="result_imgurl3_view" data-ri="0" data-src="${requestScope.imgmap.httppath}/${requestScope.imgmap.applyimg }" style="width: 220px; height: 150px;" src="./image/upload/img/${requestScope.tpath}/${requestScope.imgmap.applyimg }">
								<div style="padding-top: 5px">
									<a style="padding: 0px 5px;" class="btn btn-warning" id="ashowpic3" href="${requestScope.imgmap.httppath}/${requestScope.imgmap.applyimg }" target="_blank">查看</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:downallfile('3');">下载</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.applyimg }','${requestScope.tpath}',2,3);">右转</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.applyimg }','${requestScope.tpath}',1,3);">左转</a>
									<a data-toggle="modal" style="padding: 0px 5px;" data-target="#modal" class="btn btn-warning" href="javascript:cjimg(3);" onclick="cjimg(3,'${requestScope.imgmap.applyimg }')">裁剪</a>
								</div>
							</div>
						</div> 
							</c:otherwise>
				...
				<c:choose>
				<c:when test="${requestScope.map.authorize eq '2' }">
					<div class="col-sm-2" style="width: 20%;">
							<div class="input-group">
								<img id="result_imgurl4_view" name="result_imgurl4_view" data-ri="0" data-src="${requestScope.imgmap.httppath}/${requestScope.imgmap.authorizeimg }.new.jpg" style="width: 220px; height: 150px;" src="./image/upload/img/${requestScope.tpath}/${requestScope.imgmap.authorizeimg }.new.jpg">
								<div style="padding-top: 5px">
									<a style="padding: 0px 5px;" class="btn btn-warning" id="ashowpic4" href="${requestScope.imgmap.httppath}/${requestScope.imgmap.authorizeimg }.new.jpg" target="_blank">查看</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:downallfile('4');">下载</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.authorizeimg }.new.jpg','${requestScope.tpath}',2,4);">右转</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.authorizeimg }.new.jpg','${requestScope.tpath}',1,4);">左转</a>
									<a data-toggle="modal" style="padding: 0px 5px;" data-target="#modal" class="btn btn-warning" href="" onclick="cjimg(4,'${requestScope.imgmap.authorizeimg }.new.jpg')">裁剪</a>
								</div>
							</div>
						</div> 
				</c:when>
				...
				<c:otherwise>
					<div class="col-sm-2" style="width: 20%;">
							<div class="input-group">
								<img id="result_imgurl4_view" name="result_imgurl4_view" data-ri="0" data-src="${requestScope.imgmap.httppath}/${requestScope.imgmap.authorizeimg }" style="width: 220px; height: 150px;" src="./image/upload/img/${requestScope.tpath}/${requestScope.imgmap.authorizeimg }">
								<div style="padding-top: 5px">
									<a style="padding: 0px 5px;" class="btn btn-warning" id="ashowpic4" href="${requestScope.imgmap.httppath}/${requestScope.imgmap.authorizeimg }" target="_blank">查看</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:downallfile('4');">下载</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.authorizeimg }','${requestScope.tpath}',2,4);">右转</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.authorizeimg }','${requestScope.tpath}',1,4);">左转</a>
									<a data-toggle="modal" style="padding: 0px 5px;" data-target="#modal" class="btn btn-warning" href="" onclick="cjimg(4,'${requestScope.imgmap.authorizeimg }')">裁剪</a>
								</div>
							</div>
						</div> 
				</c:otherwise>
				...
				<c:choose>
				<c:when test="${requestScope.map.hz eq '2' }">
																<div class="col-sm-2" style="width: 20%;">
							<div class="input-group">
								<img id="result_imgurl5_view" name="result_imgurl5_view" data-ri="0" data-src="${requestScope.imgmap.httppath}/${requestScope.imgmap.hzimg }.new.jpg" style="width: 220px; height: 150px;" src="./image/upload/img/${requestScope.tpath}/${requestScope.imgmap.hzimg }.new.jpg">
								<div style="padding-top: 5px">
									<a style="padding: 0px 5px;" class="btn btn-warning" id="ashowpic5" href="${requestScope.imgmap.httppath}/${requestScope.imgmap.hzimg }.new.jpg" target="_blank">查看</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:downallfile('5');">下载</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.hzimg }.new.jpg','${requestScope.tpath}',2,5);">右转</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.hzimg }.new.jpg','${requestScope.tpath}',1,5);">左转</a>
									<a data-toggle="modal" style="padding: 0px 5px;" data-target="#modal" class="btn btn-warning" href="javascript:cjimg(5);" onclick="cjimg(5,'${requestScope.imgmap.hzimg }.new.jpg')">裁剪</a>
								</div>
							</div>
						</div> 
				</c:when>
				...
				<c:otherwise>
																<div class="col-sm-2" style="width: 20%;">
							<div class="input-group">
								<img id="result_imgurl5_view" name="result_imgurl5_view" data-ri="0" data-src="${requestScope.imgmap.httppath}/${requestScope.imgmap.hzimg }" style="width: 220px; height: 150px;" src="./image/upload/img/${requestScope.tpath}/${requestScope.imgmap.hzimg }">
								<div style="padding-top: 5px">
									<a style="padding: 0px 5px;" class="btn btn-warning" id="ashowpic5" href="${requestScope.imgmap.httppath}/${requestScope.imgmap.hzimg }" target="_blank">查看</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:downallfile('5');">下载</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.hzimg }','${requestScope.tpath}',2,5);">右转</a>
									<a style="padding: 0px 5px;" class="btn btn-warning" href="javascript:zyxz('${requestScope.imgmap.hzimg }','${requestScope.tpath}',1,5);">左转</a>
									<a data-toggle="modal" style="padding: 0px 5px;" data-target="#modal" class="btn btn-warning" href="javascript:cjimg(5);" onclick="cjimg(5,'${requestScope.imgmap.hzimg }')">裁剪</a>
								</div>
							</div>
						</div> 
				</c:otherwise>
				...
				<div class="box-header with-border">
			<h3 class="box-title">征信查询结果处理</h3>
		</div>
		<div class="box-body">
			<div class="form-group">
					...
					<div class="row inline-from">
						<div class="col-sm-3">
							<div class="input-group">
								...
								<input type="hidden" id="bit" name="bit"  value="${requestScope.map.sum_bit }" />
            <select name="bc_status" class="form-control" id="bc_status" onchange="autoremark();">
						...
						<div class="col-sm-3">
							<div class="input-group">
								...
								<input type="hidden" id="shzt" name="shzt"  value="${requestScope.map.shzt }" />
						<select name="c_tag" class="form-control" id="c_tag" >
						...
						<div class="col-sm-3">
							<div class="input-group">
							 ...
							 <select name="book_status" class="form-control" id="book_status" onchange="autoremark2();">
                            	<option selected="selected" value="0"></option>
                            	<option value="1" ${requestScope.map.return_type==1?"selected='selected'":''}>原件不符</option>
                            	<option value="2" ${requestScope.map.return_type==2?"selected='selected'":''}>已完结</option>
                            	<option value="3" ${requestScope.map.return_type==3?"selected='selected'":''}>已扣款</option> 
                             </select>
							</div>
						</div>
						<div class="col-sm-3">
							<div class="input-group">
								<input class="form-control" name="c_book_no_black" id="c_book_no_black" type="text"> <span class="input-group-addon"><a href="javascript:$('#c_book_no_black').val($('#c_book_no').val());">授权书黑名单</a></span>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">上传查询结果（PDF）
				</label>
				<div class="col-sm-10">
					<div class="row inline-from">
					<div class="input-group">
<img id="result_pdf_view" name="result_pdf_view" style="width: 150px; heigth: 150px;" src="sh/none.jpg">
<input id="result_pdf" name="result_pdf" value="" type="hidden"> 
<input id="upload_result_pdf"   value="" name="upload_result_pdf" accept="application/pdf" style="position: absolute; ; left: 1px; top: 1px; width: 150px; height: 150px; opacity: 0;" type="file">
<a id="lblresult_pdf" name="lblresult_pdf"  href="${requestScope.pmap.pdfurl }" target="_blank" ></a>
<script>

$('#upload_result_pdf').on('change',function (){	
	//alert(txt+"--"+size);
	var formData = new FormData();
    formData.append("file", document.getElementById("upload_result_pdf").files[0]); 
    ...
    $.ajax({
        ...
        */
        ...
        success: function (data) {
        	...
        	if(res!=null){        		
        		 alert("上传成功！");
        		 var num=res.fl/1024/1024;
    document.getElementById("lblresult_pdf").text="查看(文件大小:"+num.toFixed(2)+"MB)";
	...
	$('#remark').focus();
					...
					<div class="row inline-from">
						<div class="col-sm-8">
							<div class="input-group">
								...
								<a href="javascript:remarkmove();">清除</a>
								</span>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="input-group">
								<span class="input-group-addon">留言快速通道</span>
								 <select class="form-control" id="cyly" onchange="setremark(this)">
												...
												<option value="该客户因四个工作日内有查询记录回退，编号无法再次使用">该客户因四个工作日内有查询记录回退，编号无法再次使用</option>	
												<option value="图五不要手机过远拍摄否则看不清申请书编码，请重新拍摄上传。">图五不要手机过远拍摄否则看不清申请书编码，请重新拍摄上传。</option>
												<option value="图五合照需拍全申请书内容的同时请手机横向拍摄">图五合照需拍全申请书内容的同时请手机横向拍摄</option>						
												<option value="图一身份证需放在申请书编号下方拍摄，图二请上传身份证反面，图五合照身份证需放在编号下方一同拍摄">图一身份证需放在申请书编号下方拍摄，图二请上传身份证反面，图五合照身份证需放在编号下方一同拍摄</option>						
												<option value="图一与上传信息不符。">图一与上传信息不符。</option>						
												<option value="图1中身份证请放在申请书上方拍摄。图五请横向拍摄">图1中身份证请放在申请书上方拍摄。图五请横向拍摄</option>						
												<option value="名字编辑错误。图12身份证请放在申请书上拍摄，">名字编辑错误。图12身份证请放在申请书上拍摄，</option>						
												<option value="图三填写日期有涂改，图四缺少填写日期，图五需本人手持身份证在申请书编码下方拍摄。">图三填写日期有涂改，图四缺少填写日期，图五需本人手持身份证在申请书编码下方拍摄。</option>						
												<option value="图三申请书与图五申请书不符，图四请上传授权书，请重新上传。">图三申请书与图五申请书不符，图四请上传授权书，请重新上传。</option>						
												<option value="该车市场保值度较为一般。">该车市场保值度较为一般。</option>						
												<option value="图三申请书与图五申请书不符，图四上传错误，请重新上传。">图三申请书与图五申请书不符，图四上传错误，请重新上传。</option>						
												</select>
							</div>
						</div>
					</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<textarea id="text" name="text" style="width: 100%; height: 200px" class="form-control" readonly="readonly">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label">API 身份证识别结果：</label>
			<div class="col-sm-10">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label">
				<a href="javascript:doocrsfz(1);doocrsfz(2);">OCR身份证自动识别</a>
			</label>
			<div class="col-sm-10">
				<div class="input-group">
					<span class="input-group-addon">OCR身份证识别</span> <span class="input-group-addon"><a href="javascript:doocrsfz(1);">身份证正面识别</a>
						| <a href="javascript:doocrsfz(2);">身份证背面识别</a></span>
				</div>
			</div>
		</div>
	</div></div>
...
$(function(){
	...
	//$(".btn.btn-primary.pull-right").css("display","none");
	if($("#bit").val()==4){
		document.getElementById("bc_status").options[0].selected=true;
	}
    if($("#bit").val()==5){
    	document.getElementById("bc_status").options[1].selected=true;
	}
    if($("#bit").val()==6){
    	document.getElementById("bc_status").options[2].selected=true;
    }
    if($("#shzt").val()==1){
    	document.getElementById("c_tag").options[1].selected=true;
    }
...
//			window.console.error('remark null');
	...
	if ($("#bc_status").val()!=5 && $("#book_status").val()!=0){
		alert("订单为查询完成的状态时方能修改授权书状态,请检测授权书状态的设置!"); 
		return false;
	}
	return true;
} 
...
function downallfile(fid){	
	 var id=document.getElementById("uid").value;
	 //alert(id+"---"+fid);
     window.open('downloadimg.do?id='+id+'&fid='+fid);
}
function dodownall(){
	for (fid=1;fid<=5;fid++){
	...
	$.post("ajax.php?do=rpic",{src:xfile,rtype:type,id:gid,fid:fid},function(res){
		...
		if(res.succ){
			...
			$("#result_imgurl"+fid+"_view").attr("src",tmpstr2+"?"+timestamp);
		}
	});
}
		function au(){
...
function autoremark(){
	if ($("#bc_status").val()==5){//完成
		$("#remark").val("查询完成，详情请点击订单详情页查看！");
	}else{
		$("#remark").val("");
	}		
}
function autoremark2(){
	var text = $("#book_status").find("option:selected").text();  
	if ($("#book_status").val()>0){//完成
		$("#remark").val("查询完成，授权书"+text);
	}
}

function doocrsfz(ashowpic){
	//alert(ashowpic);
	var filePath1="/opt/javaimg/image/upload/img/";
	//var selectfund = $("#selectfund_id").val();
	var filePath=document.getElementById("i"+ashowpic).value;
    //alert(filePath1+filePath);
	$.post("sfzsb.do", {filePath:filePath1+filePath},
	function (data) {
		var res =eval("(" + data + ")");
		if(res.status==0 || res.status=='OK'){
			...
			for(i in xdata ){
   			...
   			if(res.data.item.cardno.length>0){
   	   			var oldidcard = $("#c_card_no").val();
   	   			var newidcard = res.data.item.cardno;
   	   			if (oldidcard!=newidcard && window.confirm('系统识别的身份证号码跟用户填写的不一样,是否替换?系统识别结果:'+newidcard)){
					$("#c_card_no").val(res.data.item.cardno);
   	   			}
   	   			var oldidcard = $("#c_name").val();
   	   			var newidcard = res.data.item.name;
   	   			if (oldidcard!=newidcard && window.confirm('系统识别的身份证姓名跟用户填写的不一样,是否替换?系统识别结果:'+newidcard)){
					$("#c_name").val(res.data.item.name);
   	   			}
				$("#c_card_type").val('0');
				$("#c_nation").val(res.data.item.folk);
			...
			alert('出错：代码-'+res.status+'\r\n出错信息：'+res.info+res.error);
		}
	})
	
}
	function dozbar(){
		$.post("ajax.php?do=zxbookno_zbar",{fid:24668},function(res){
			eval("var res="+res);
			if(res.succ){
				document.getElementById("booka").innerHTML="授权书:验证通过√"+res.days;
			}else{
				document.getElementById("booka").innerHTML="×:"+res+"×";
				$("#booka").css("background","#dd4b39");
			//	alert(res);
			}
		});
	}	
	...
	{  
		...
		var basekey =  49;//alt +1开始
		if((a==basekey)&&(event.altKey))  
		{  
			dodownall();		  
		}  
		if((a==basekey+1)&&(event.altKey))  
		{  
			javascript:doocrsfz(2);doocrsfz(3);	 
			
		}  
		if((a==basekey+2)&&(event.altKey))  
		{  
			$('#c_book_no_black').val($('#c_book_no').val());
			
		}  
		if((a==basekey+3)&&(event.altKey))  
		{  
			dozbar()
...
function ybts(){
	var id=document.getElementById("uid").value;	
	$.post("ybts.do",{orderNo:id},function(res){});
}
			...
			<div class="box-footer">
				...
				<button type="submit" class="btn btn-primary pull-right" onclick="ybts();"  style="">保存提交</button> 
			</div>
		</div>
...
<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width: 830px;" >
     ...
     <input type="hidden" value="${requestScope.tpath}" size="4"  id="timenum" name="timenum"   />
     ...
     <input type="hidden" size="4" value="${requestScope.map.id }" id="uid" name="uid" />
     <input type="hidden" size="4" value="${requestScope.name }"  id="name" name="name" />
     </form>
    </div>
