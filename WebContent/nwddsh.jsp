...
function a3(){
	...
	window.location.href ="nwddsh.do?pagesize="+s;

}
function a2(){
	var khgsname=$("#khgsname").val();
	window.location.href ="nwddsh.do";

}
function a1(size) {
	alert(size);
	window.location.href ="nwddsh.do?pagesize="+size+"&pagenow=3";
}
</script>
...
$('li.active').parents('li').addClass('treeview').addClass('active');
			...
			<div class="admin-tools">
				...
				<div class="col-sm-7 admin-button">
					...
					<div class="col-sm-5 admin-page-top hidden-xs">
					            <select id="khgsname" onchange="a2()" class="form-control">
	...
	<tbody>
			...
			<a href="tozximg.do?id=${c.id }&name=${requestScope.name}&api=${requestScope.api}" class="btn btn-default">
			...
			<span class="label label-success">已撤销</span>	
               ...
               <%
				...
				%> 
				  <li>
				  <a href="nwddsh.do?pagesize=${requestScope.size}&pagenow=<%=i+1%>"><%=i+1 %></a>
				  </li> 
				<%
