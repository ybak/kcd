		...
		<header class="main-header" > <!-- Logo -->
		 <a href="" class="logo" style="background-color:#12122b;"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini">
					<c:if test="${empty sessionScope.pd.fs_oemimgurl }"><img src="${pageContext.request.contextPath }/kjs_icbc/kjs_icbc_style/images/59316cc5930b6.png" class="logoimg" width="20" height="20">
				    </c:if>
				...
				<span class="logo-lg">
				<c:if test="${empty sessionScope.pd.fs_oemimgurl }"><img src="${pageContext.request.contextPath }/kjs_icbc/kjs_icbc_style/images/59316cc5930b6.png" class="logoimg hidden-xs" width="20" height="20"></c:if>
