...
<form id="zx_Form" name="zx_Form"  class="form-horizontal ng-pristine ng-valid ng-scope">
    ...
    <input id="status_id" name="status_id" value="3" type="hidden" />
	...
	<!-- ngIf: notUseButton -->
	   <div class="form-group ng-scope">
		...
		<div class="col-sm-8"> 
			<input type="radio" value="1"  onchange="sh_result1(this.value)" id="zx_status" name="zx_status"  class="ng-pristine ng-untouched ng-valid ng-not-empty">通过  
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" value="2"  onchange="sh_result1(this.value)" id="zx_status" name="zx_status"  class="ng-pristine ng-untouched ng-valid ng-not-empty">不通过
			 &nbsp;&nbsp;&nbsp;&nbsp; 
		    <input type="radio" value="3"  onchange="sh_result1(this.value)" id="zx_status" name="zx_status"  class="ng-pristine ng-untouched ng-valid ng-not-empty">回退补件
	    </div>
	   </div>		
		<div class="form-group">
		<label class="col-sm-2 control-label">备注</label>
		<div class="col-sm-8">
			<textarea id="zx_remark" name="zx_remark" class="form-control ng-pristine ng-valid ng-not-empty ng-touched"  style="margin: 0px -5.34375px 0px 0px; height: 50px; width: 545px;"></textarea>
		</div>
	   </div>	
	...
	<div id="zdr_hai" class="form-group" style="margin-top: 20px;">
		...
		<div class="col-sm-8">
			<textarea  id="zx_result1" name="zx_result1" class="form-control ng-pristine ng-valid ng-not-empty ng-touched"  style="margin: 0px -5.34375px 0px 0px; height: 141px; width: 545px;"></textarea>
		</div>
	</div>  
	<div class="form-group">
	...
	<div id="ghr1_hai" class="form-group" style="margin-top: 20px;">
		<label class="col-sm-2 control-label">征信报告</label>
		<div class="col-sm-8">
			<textarea  id="zx_result2" name="zx_result2" class="form-control ng-pristine ng-valid ng-not-empty ng-touched"  style="margin: 0px -5.34375px 0px 0px; height: 141px; width: 545px;"></textarea>
		</div>
	</div>
	<div class="form-group">
	<label class="col-sm-2 control-label">大数据报告</label>
	...
	<div id="ghr2_hai" class="form-group" style="margin-top: 20px;">
		<label class="col-sm-2 control-label">征信报告</label>
		<div class="col-sm-8">
			<textarea  id="zx_result3" name="zx_result3" class="form-control ng-pristine ng-valid ng-not-empty ng-touched"  style="margin: 0px -5.34375px 0px 0px; height: 141px; width: 545px;"></textarea>
		</div>
	</div>
    <div class="form-group">
	<label class="col-sm-2 control-label">大数据报告</label>
	...
	<div id="zdrpo_hai" class="form-group" style="margin-top: 20px;">
		<label class="col-sm-2 control-label">征信报告</label>
		<div class="col-sm-8">
			<textarea  id="zx_result4" name="zx_result4" class="form-control ng-pristine ng-valid ng-not-empty ng-touched"  style="margin: 0px -5.34375px 0px 0px; height: 141px; width: 545px;"></textarea>
		</div>
	</div>
<div class="form-group">
	<label class="col-sm-2 control-label">大数据报告</label>
...
<script type="text/javascript">
     ...
     function dsj_bg(id,dsjtype,report_id) {
    	 ...
    	 if(dsj_code!=null&&dsj_code!=""){
           ...
           $('#dsjModal').modal({ show: true, backdrop: 'static' }); 
    	 }else{
    		 alert("大数据编码不能为空!");
    	 }
...
function erp_zxsh(){
	var val=$('input:radio[name="zx_status"]:checked').val();
    if(val==null){
        alert("请选择审核结果!");
        return false;
    }else{
...
<!-- 模态框（Modal） -->
<div class="modal fade" id="dsjModal" tabindex="-1" role="dialog" aria-labelledby="dsjModalLabel" aria-hidden="true">
