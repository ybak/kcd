...
<c:if  test="${fn:contains(sessionScope.pd.purview_map,'trzg_44')==true}">
...
<form id="nstrsh_44" name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope">
...
<div class="modal-footer">
	...
	<a onclick="erp_nstrsh_44()"  class="btn btn-primary" >提交</a>	
</div>
</form>
<script type="text/javascript">
function erp_nstrsh_44(){
	   	var form = new FormData(document.getElementById("nstrsh_44"));
	   	$.ajax({
	           url:"${pageContext.request.contextPath}/erp/erp_nstrsh_44.do",
	           type:"post",
	           data:form,
	           processData:false,
	           contentType:false,
