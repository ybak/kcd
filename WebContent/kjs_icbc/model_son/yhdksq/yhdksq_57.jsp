...
<!-- 	<div class="form-group" ng-if="notUseButton && task.postRet != null">
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input name="yhdksh_57_kdgs" class="form-control ng-pristine ng-untouched ng-valid ng-empty">
		</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input name="yhdksh_57_kddh" class="form-control ng-pristine ng-untouched ng-valid ng-empty">
		</div>
		...
		<div class="col-sm-3">
			<div class="input-group date ng-isolate-scope ng-not-empty ng-valid ng-valid-required" >
  				<input placeholder="请选择日期" id="date_57" name="yhdksh_57_jcrq" class="form-control" type="text"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
			</div>
		</div>
	</div> 
	<!-- ngIf: !notUseButton -->
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">上传快递图片</label>
     	<!-- <div class="col-sm-3">
     		<input type="text" name="yhdksh_57_bcimg1" >
	     	<li>
