...
<c:if  test="${fn:contains(sessionScope.pd.purview_map,'jgsjqr_94')==true}">
...
<form id="tdtfsh_94" name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope">
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input type="radio" value="已收到"  class="ng-pristine ng-untouched ng-valid ng-not-empty" name="tdtfsh_94_msg">已收到
	            &nbsp;&nbsp;&nbsp;&nbsp;
	        <input type="radio" value="未收到"  class="ng-pristine ng-untouched ng-valid ng-not-empty" name="tdtfsh_94_msg">未收到
		</div>
		<label class="col-sm-1 control-label">收件日期</label>
		<div class="col-sm-3">
        <div class="input-group date ng-isolate-scope ng-empty ng-valid">
        <input placeholder="请选择日期" id="date_94" name="tdtfsh_94_date"  class="form-control selectData" type="text">
	...
	<div class="modal-footer">
		...
		<a onclick="erp_tdtfsh_94()" class="btn btn-primary" >提交</a>
	</div>
</form>
<script>
...
function erp_tdtfsh_94(){
	var val=$('input:radio[name="result_1_code"]:checked').val();
    if(val==null){
        alert("请选择材料复核结果!");
        return false;
    }else{
	    var form = new FormData(document.getElementById("tdtfsh_94"));
	   	$.ajax({
	           url:"${pageContext.request.contextPath}/erp/erp_tdtfsh_94.do",
	           type:"post",
	           data:form,
	           processData:false,
	           contentType:false,
