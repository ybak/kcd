...
<c:if  test="${fn:contains(sessionScope.pd.purview_map,'gsqrdz_92')==true}">
...
<form id="tdtfsh_92" name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope">
		...
		<div class="form-group ng-scope" >
			...
			<div class="col-sm-3">
				<input type="radio" value="1"  class="ng-pristine ng-untouched ng-valid ng-not-empty" name="result_1_code">到账、确认无误（已垫资已收件）  
				&nbsp;&nbsp;&nbsp;&nbsp;
		        <input type="radio" value="2"   class="ng-pristine ng-untouched ng-valid ng-not-empty" name="result_1_code">已垫资未收件
				&nbsp;&nbsp;&nbsp;&nbsp;
		        <input type="radio" value="3"   class="ng-pristine ng-untouched ng-valid ng-not-empty" name="result_1_code">金额不符/未到账
			</div>	
		</div>
		<div class="form-group">
