...
%>
<c:if  test="${fn:contains(sessionScope.pd.purview_map,'dycljh_77')==true}">
...
<form id="erp_form" name="erp_form" class="form-horizontal ng-pristine ng-valid ng-scope ng-valid-required ng-valid-pattern ng-valid-maxlength">
    ...
    <input id="status_id" name="status_id" value="77" type="hidden" />
    ...
    <div class="form-group">
		...
		<div class="col-sm-3">
			<input id="kdgs" name="kdgs" class="form-control ng-pristine ng-untouched ng-valid ng-not-empty" >
		</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input id="kddh" name="kddh" class="form-control ng-pristine ng-untouched ng-valid ng-not-empty" >
		</div>
  ...
  <input id="jcrq" name="jcrq" class="form-control" type="text"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
</div>
		</div>
	</div> 
	<div class="form-group">
...
function erp(){
	...
	$.ajax({
        url:"${pageContext.request.contextPath }/erp/erp_dygd_77.do",
        type:"post",
        data:form,
        processData:false,
        contentType:false,
