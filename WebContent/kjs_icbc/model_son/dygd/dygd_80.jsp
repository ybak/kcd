...
%>
<c:if  test="${fn:contains(sessionScope.pd.purview_map,'yhsjqr_80')==true}">
...
<form id="erp_form" name="erp_form" class="form-horizontal ng-pristine ng-valid ng-scope">
    ...
    <input id="status_id" name="status_id" value="80" type="hidden" />
...
<div class="input-group date ng-isolate-scope ng-empty ng-valid">
  <input id="ksrq" name="ksrq" class="form-control" type="text">
...
function erp(){
	...
	$.ajax({
        url:"${pageContext.request.contextPath }/erp/erp_dygd_80.do",
        type:"post",
        data:form,
        processData:false,
        contentType:false,
