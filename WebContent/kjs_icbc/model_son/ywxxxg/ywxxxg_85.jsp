...
<c:if  test="${fn:contains(sessionScope.pd.purview_map,'xtyw_85')==true}">
...
<form id="ywxxxgsh_85" name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope">
   <!-- ngIf: notUseButton -->
...
<div class="modal-footer">
	...
	<a onclick="erp_ywxxxgsh_85()"  class="btn btn-primary" >提交</a>	
</div>
</form>
<script type="text/javascript">
function erp_ywxxxgsh_85(){
	var val=$('input:radio[name="result_1_code"]:checked').val();
    if(val==null){
        alert("请选择审核结果!");
        return false;
    }else{
	   	var form = new FormData(document.getElementById("ywxxxgsh_85"));
	   	$.ajax({
	           url:"${pageContext.request.contextPath}/erp/erp_ywxxxgsh_85.do",
	           type:"post",
	           data:form,
	           processData:false,
	           contentType:false,
