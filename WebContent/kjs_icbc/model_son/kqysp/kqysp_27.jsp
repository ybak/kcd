...
<c:if  test="${fn:contains(sessionScope.pd.purview_map,'zgsh_27')==true}">
...
<form id="kqyspsh_27" name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope ng-valid-required">
...
<div class="modal-footer">
	...
	<a onclick="erp_kqyspsh_27()"  class="btn btn-primary" >提交</a>	
</div>
</form>
<script type="text/javascript">
function erp_kqyspsh_27(){
	var val=$('input:radio[name="result_1_code"]:checked').val();
    if(val==null){
        alert("请选择审核意见结果!");
        return false;
    }else{
	   	var form = new FormData(document.getElementById("kqyspsh_27"));
	   	$.ajax({
	           url:"${pageContext.request.contextPath}/erp/erp_kqyspsh_27.do",
	           type:"post",
	           data:form,
	           processData:false,
	           contentType:false,
