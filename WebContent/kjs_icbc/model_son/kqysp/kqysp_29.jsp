...
<c:if  test="${fn:contains(sessionScope.pd.purview_map,'zjlsh_29')==true}">
...
<form id="kqyspsh_29" name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope ng-valid-required">
    ...
    <!-- ngIf: (rootData.taskDefKey && rootData.taskDefKey != 'creditSrc_bizAddr_apply' && action != 'detail')||(taskAct.activityId && taskAct.activityId != 'creditSrc_bizAddr_apply') --><div ng-if="(rootData.taskDefKey &amp;&amp; rootData.taskDefKey != 'creditSrc_bizAddr_apply' &amp;&amp; action != 'detail')||(taskAct.activityId &amp;&amp; taskAct.activityId != 'creditSrc_bizAddr_apply')" class="form-group ng-scope">        
        ...
        <div class="col-sm-8">
            ...
            <input type="radio" value="3" class="ng-pristine ng-untouched ng-valid ng-not-empty" name="result_1_code">驳回&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <!-- ngIf: (rootData.taskDefKey && rootData.taskDefK主管审核ey != 'creditSrc_bizAddr_apply' && action != 'detail')||(taskAct.activityId && taskAct.activityId != 'creditSrc_bizAddr_apply') --><div ng-if="(rootData.taskDefKey &amp;&amp; rootData.taskDefKey != 'creditSrc_bizAddr_apply' &amp;&amp; action != 'detail')||(taskAct.activityId &amp;&amp; taskAct.activityId != 'creditSrc_bizAddr_apply')" class="form-group ng-scope">
...
<div class="modal-footer">
	...
	<a onclick="erp_kqyspsh_29()"  class="btn btn-primary" >提交</a>	
</div>
</form>
<script type="text/javascript">
function erp_kqyspsh_29(){
	var val=$('input:radio[name="result_1_code"]:checked').val();
    if(val==null){
        alert("请选择审核意见结果!");
        return false;
    }else{
	   	var form = new FormData(document.getElementById("kqyspsh_29"));
	   	$.ajax({
	           url:"${pageContext.request.contextPath}/erp/erp_kqyspsh_29.do",
	           type:"post",
	           data:form,
	           processData:false,
	           contentType:false,
