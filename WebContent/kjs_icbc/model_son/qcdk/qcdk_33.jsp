...
%>
<c:if  test="${fn:contains(sessionScope.pd.purview_map,'zysh_33')==true}">
<li class="text-primary"><em>专员审核结果</em>
    ...
    <input id="status_id" name="status_id" value="33" type="hidden" />
    <input id="yw_id" name="yw_id" value="${requestScope.yw_id }" type="hidden" />
	<input id="dk_id" name="dk_id" value="${pd.dkid }" type="hidden" />	
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="radio" value="1"												
							 id="ds_status"
							name="ds_status" ${requestScope.yhds_code eq '1'?"selected:'selected'":'' }
							class="ng-pristine ng-untouched ng-valid ng-not-empty">通过
						&nbsp;&nbsp;&nbsp;&nbsp; 
						<input type="radio" value="2" ${requestScope.yhds_code eq '2'?"selected:'selected'":'' }
							 id="ds_status"
							name="ds_status"
