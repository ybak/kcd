...
%>
<c:if  test="${fn:contains(sessionScope.pd.purview_map,'zgsh_35')==true}">
<li class="text-primary"><em>主管审核结果</em>
    ...
    <input id="status_id" name="status_id" value="35" type="hidden" />
    ...
    <input id="dt_date" name="dt_date" value="${pData2.dt_edit }" type="hidden" />
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						&nbsp;&nbsp;&nbsp;&nbsp; 
						<input type="radio" value="2" ${requestScope.yhds_code eq '2'?"checked='checked'":'' }
							 id="ds_status"
							name="ds_status"
