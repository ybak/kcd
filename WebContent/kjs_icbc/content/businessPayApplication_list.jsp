			...
			<table class="table table-bordered table-hover">
				<tbody>	
					...
					<tr>
						...
						<td class="text-center">
							<!-- 还款情况详情 -->
							<a href="${pageContext.request.contextPath }/businessPayApplicationController/selectdetail.do?type=dhywgl&dn=businessPayApplication&qn=form&c_cardno=${busin.c_cardno}">
