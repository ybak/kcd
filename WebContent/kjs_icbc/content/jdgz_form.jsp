...
<%-- <a style="margin-bottom: 20px;"  class="btn btn-mini btn-primary">${yw.name }</a>
	...
	<div style="border:1px solid #478FCA;   margin:5px; padding:10px 10px 10px 10px;border-radius: 10px;">
	 
	<ul id="yw" class="nav nav-tabs" >

	 <li ${requestScope.type_id eq '1'?"class='active'":''} >
	 <c:if test="${!empty pd.gems_code}">
	 <a id="yw1" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=1"  >征信查询</a>
	 </c:if>
	 <c:if test="${empty pd.gems_code}">
	 ...
	 <a id="yw2" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=2"  >征信通融</a>
	 </c:if>
	 ...
	 <a id="yw3" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=3"  >车辆评估</a>
	 </c:if>
	 <c:if test="${empty pd.cars_gems_code}">
	 ...
	 <a id="yw4" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=4"  >银行电审</a>
	 </c:if>
	 <c:if test="${empty pd.kk_gems_code}">
     ...
     <c:if test="${!empty pd.kk_gems_code}">
	 <a id="yw5" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=5" >开卡申请</a>
	 </c:if>
	 <c:if test="${empty pd.kk_gems_code}">
	 ...
	 <a id="yw6" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=6" >视频面签</a>
	 </c:if>
	 <c:if test="${empty pd.mq_gems_code}">
	 ...
	 <a id="yw7" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=7" >跨区域业务审批</a>
	 ...
	 <a id="yw8" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=8" >汽车贷款</a>
	 </c:if>
	 <c:if test="${empty pd.dk_gems_code}">
	...
	<a id="yw9" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=9" >内审通融</a>
	<!--  <a href="#yw9" data-toggle="tab" disabled="disabled" class="btn btn-mini licolor">内审通融</a> -->
	 </li>
     <li style="display:block;text-align:center; line-height:50px"><i class="fa fa-long-arrow-right"></i></li>
     
     <li ${requestScope.type_id eq '10'?"class='active'":''}>
	 <a id="yw10" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=10" >资金分配</a>
	 ...
	 <a id="yw11" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=11" >银行贷款申请</a>
	 ...
	 <a id="yw12" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=12" >公司归档</a>
	 ...
	 <a id="yw13" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=13" >抵押归档</a>
	 ...
	 <a id="yw14" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=14" >业务信息修改</a>
	 ...
	 <a id="yw14" style="background-color:#3c8dbc;color: #ffffff;" href="${pageContext.request.contextPath }/erp/wdrw_from.do?type=wlghd&dn=jdgz&qn=form&cn=${requestScope.cn }&icbc_id=${requestScope.icbc_id }&type_id=15" >退单退费</a>
