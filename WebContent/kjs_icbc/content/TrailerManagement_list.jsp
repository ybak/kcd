		...
		<section class="content">
			<div class="admin-tools">
				<div class="row">
					<div class="col-sm-10">
						<div class="btn-group">		
							<form class="form-horizontal" action="${pageContext.request.contextPath}/trailerManagementController/mortgageRecord.do?type=${requestScope.type }&dn=VehicleMortgage&qn=list&cn=w1" enctype="multipart/form-data" method="post">
							...
							<script type="text/javascript">
							    function a3(){
									...
									window.location.href ="${pageContext.request.contextPath}/trailerManagementController/mortgageRecord.do?type=${requestScope.type }&dn=VehicleMortgage&qn=list&pagesize="+s+"&pagenow=1";
							    };
					...
					<div class="col-sm-2">
					   ...
					   <ul class="pagination no-margin">					     				       
						...
						<li>
							...
							%>
							<a href="${pageContext.request.contextPath }/trailerManagementController/mortgageRecord.do?type=${requestScope.type }&dn=VehicleMortgage&qn=list&pagesize=${requestScope.pagesize}&pagenow=${requestScope.pagenow-1}" class="btn btn-default">«</a>						
							<%				    	
					         }						
							 if(pagenow1>=1&&pagenow1<totalpage1){
							%>
		...
		<div class="foot-page">
			<c:if test="${requestScope.totalpage ge '1' }">
				<ul class="pagination no-margin">
					   ...
					   <a id="a<%=j %>" href="${pageContext.request.contextPath }/trailerManagementController/mortgageRecord.do?type=${requestScope.type }&dn=VehicleMortgage&qn=list&cn=${requestScope.cn }&selectMsg=${requestScope.selectMsg}&pagesize=${requestScope.pagesize}&pagenow=<%=j %>&fsid=${requestScope.fsid }">
					   <%=j %>
					   </a>
					   </li>
					   <%
