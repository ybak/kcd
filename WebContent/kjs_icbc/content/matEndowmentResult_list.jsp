...
laydate.render({
  elem: '#date2' //指定元素
			...
			<div class="admin-tools">
				<div class="row">
					...
					<div class="col-sm-2 admin-page-top hidden-xs">
							<select id="page_limit_select" onchange="window.location.href='${pageContext.request.contextPath }/erp/matEndowentResult_list.do?type=wdrw&dn=matEndowmentResult&cn=${requestScope.cn}&qn=list&selectMsg=${requestScope.selectMsg}&assess_cp=${requestScope.assess_cp}&pagenow=${requestScope.pagenow}&pagesize='+this.value+'&fsid=1'" class="form-control">
		...
		<div class="btn-group">
						...
						%>
						<a href="${pageContext.request.contextPath }/erp/matEndowentResult_list.do?type=wdrw&dn=matEndowmentResult&cn=${requestScope.cn }&qn=list&selectMsg=${requestScope.selectMsg}&assess_cp=${requestScope.assess_cp}&pagesize=${requestScope.pagesize}&pagenow=${requestScope.pagenow-1}&fsid=${requestScope.fsid }" class="btn btn-default">«</a>						
						<%				    	
				         }						
						 if(pagenow1>=1&&pagenow1<totalpage1){
						%>
			...
			<c:if test="${requestScope.totalpage ge '1' }">
				<ul class="pagination no-margin">
				       <c:if test="${requestScope.pagenow ne '1' }">
				        <li><a href="${pageContext.request.contextPath }/erp/matEndowentResult_list.do?type=wdrw&dn=matEndowmentResult&cn=${requestScope.cn }&qn=list&selectMsg=${requestScope.selectMsg}&assess_cp=${requestScope.assess_cp}&pagesize=${requestScope.pagesize}&pagenow=${requestScope.pagenow-1}&fsid=${requestScope.fsid }" aria-label="Next"><span aria-hidden="true">«</span></a></li>
				       </c:if>
					   <%
					   ...
					   <a id="a<%=j %>" href="${pageContext.request.contextPath }/erp/matEndowentResult_list.do?type=wdrw&dn=matEndowmentResult&cn=${requestScope.cn }&qn=list&selectMsg=${requestScope.selectMsg}&assess_cp=${requestScope.assess_cp}&pagesize=${requestScope.pagesize}&pagenow=<%=j %>&fsid=${requestScope.fsid }">
					   <%=j %>
					   </a>
					   </li>
					   <%
