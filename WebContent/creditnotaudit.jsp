...
function a2(){
	...
	window.location.href ="limit.do?khgsname="+khgsname;
...
$('li.active').parents('li').addClass('treeview').addClass('active');
	...
	<tbody>
			...
			<a href="tozximg.do?id=${c.id }" class="btn btn-default">
			...
			<c:otherwise>
				...
				%> 
				  <li>
				  <a href="limit.do?size=${requestScope.size}&pagenow=<%=i+1%>&khgsname=${requestScope.khgsname}"><%=i+1 %></a>
				  </li> 
				<%
