...
function a3(){
	...
	window.location.href ="elist.do?size="+s;

}
function a2(){
	var khgsname=$("#khgsname").val();
	window.location.href ="elist.do";

}
function a1(size) {
	alert(size);
	window.location.href ="elist.do?size="+size+"&pagenow=3";
}
</script>
...
$('li.active').parents('li').addClass('treeview').addClass('active');
	...
	<tbody>
			...
			<c:when test="${requestScope.khgsname == null }">
				...
				%> 
				  <li>
				  <a href="elist.do?size=${requestScope.size}&pagenow=<%=i+1%>"><%=i+1 %></a>
				  </li> 
				<%
