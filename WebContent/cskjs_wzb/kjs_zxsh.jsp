...
<script src="${pageContext.request.contextPath }/cskjs_css/jquery.circliful.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath }/cskjs_css/jquery.circliful.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath }/jquery-photo-gallery/jquery.photo.gallery.js" type="text/javascript"></script>
...
<body>
<form id="info_form" action="upicbc.do" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return check()">
...
<a href="downloadFile_all.do?type=icbc&id=${requestScope.icbc.id }" class="btn btn-success">一键下载所有图片</a>
			...
			<div  align="center" style="color:#ff8700;" >征信材料</div>		
				...
				<div class="col-sm-12" style="margin-top: 50px;">
					...
					<div class="col-sm-2" style="margin:20px 10px;text-align: center;">
					        ...
					        <a style="padding: 0px 5px;" class="btn btn-warning" id="" href="downloadFile.do?fileUrl=http://a.kcway.net/assess/${requestScope.icbc.imgstep2_1 }&fileName=身份证正面"  >下载</a>							
					...
					<c:if test="${!empty requestScope.icbc.imgstep2_2 }">
						<div class="col-sm-2" style="margin:20px 10px;text-align: center;">
					        ...
					        <a style="padding: 0px 5px;" class="btn btn-warning" id="" href="downloadFile.do?fileUrl=http://a.kcway.net/assess/${requestScope.icbc.imgstep2_2 }&fileName=身份证反面" >下载</a>							
					...
					<div class="col-sm-2" style="margin:20px 10px;text-align: center;">							
					        ...
					        <a style="padding: 0px 5px;" class="btn btn-warning" id="" href="downloadFile.do?fileUrl=http://a.kcway.net/assess/${requestScope.icbc.imgstep2_3 }&fileName=手持身份证授权书/面签照" target="_blank">下载</a>							
					...
					<div class="col-sm-2" style="margin:20px 10px;text-align: center;">							
							...
							<a style="padding: 0px 5px;" class="btn btn-warning" id="" href="downloadFile.do?fileUrl=http://a.kcway.net/assess/${requestScope.icbc.imgstep2_4 }&fileName=手持身份证授权书/面签照" >下载</a>							
					...
					<c:if test="${!empty requestScope.icbc.imgstep2_5 }">
						<div class="col-sm-2" style="margin:20px 10px;text-align: center;">							
					        ...
					        <a style="padding: 0px 5px;" class="btn btn-warning" id="" href="downloadFile.do?fileUrl=http://a.kcway.net/assess/${requestScope.icbc.imgstep2_5 }&fileName=授权书" >下载</a>							
					...
					<div class="col-sm-2" style="margin:20px 10px;text-align: center;">	
							...
							<a style="padding: 0px 5px;" class="btn btn-warning" id="" href="downloadFile.do?fileUrl=http://a.kcway.net/assess/${imgs }&fileName=补充材料<%=i %>" >下载</a>														
		...
		<div class="col-sm-10">
			<div class="row inline-from">
				<div class="col-sm-4">
					...
					<option value="0" >请选择</option>
					<option value="1" ${requestScope.icbc.tr_status==1?"selected='selected'":''}>用户提交</option>
                    <option value="2" ${requestScope.icbc.tr_status==2?"selected='selected'":''}>通过</option>
                    <option value="3" ${requestScope.icbc.tr_status==3?"selected='selected'":''}>不通过</option>                        
                    </select>
                    </div>
			   </div>		               
	  </div>
...
<div class="col-sm-2" style="margin:20px 10px;text-align: center;">	
		...
		<a style="padding: 0px 5px;" class="btn btn-warning" id="" href="downloadFile.do?fileUrl=http://a.kcway.net/assess/${imgss }&fileName=通融材料<%=img %>" target="_blank">下载</a>														
		...
		<div class="col-sm-10">
			<div class="row inline-from">
				<div class="col-sm-4">
                    ...
                    <option value="6" ${requestScope.icbc.bc_status==6?"selected='selected'":''}>撤销</option>
                    </select>
                    </div>
			   </div>
			   <div class="col-sm-4">
...
<c:forEach items="${requestScope.iResultlist}" var="re">${fn:substring(re.dt_add,0,19)}:状态：${re.statusremark },留言：${re.remark }
		...
		<div class="footer-wrap">
			<div class="box-footer">
				<button type="button"  class="btn btn-default" onclick="location.href='kjs_zx.do?out=1&id=${requestScope.id}&querytype=${requestScope.querytype}&size=${requestScope.size}&status=${requestScope.status}'">取消返回</button>
