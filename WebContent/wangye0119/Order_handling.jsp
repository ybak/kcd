					...
					<div class="side_list">
						...
						<div class="widget-body">
							<ul class="b_P_Sort_list">
								...
								<li><i class="fa fa-sticky-note pink "></i> <a href="#">代付款(15)</a>
								</li>
			...
			<div class="order_list_style" id="order_list_style">
				<div class="search_style">
					...
					<ul class="search_content clearfix">
						<li><label class="l_f">订单编号</label><input name="" type="text"
							class="text_add" placeholder="输入订单编号" style="width: 250px" /></li>
					...
					<table class="table table-striped table-bordered table-hover"
						...
						<tbody>
							<tr>
								...
								<td class="order_product_name"><a href="#"
									class="product_Display"><img src="products/p_1.jpg"
										title="产品名称" /></a> <i class="fa fa-plus"></i> <a href="#"
									class="product_Display"><img src="products/p_2.jpg"
										title="产品名称" /></a></td>
								<td>456.5</td>
							...
							<tr>
								...
								<td class="order_product_name"><a href="#"
									class="product_Display"> <img src="products/p_1.jpg"
										title="产品名称" />
								</a> <i class="fa fa-plus"></i> <a href="#" class="product_Display">
								...
								<td></td>
								<td><a title="订单详细" href="order_detailed.html"
									class="btn btn-xs btn-info order_detailed"><i
										class="fa fa-list bigger-120"></i></a> <a title="删除"
									href="javascript:;" onclick="Order_form_del(this,'1')"
									class="btn btn-xs btn-warning"><i
							...
							<tr>
								...
								<td>2</td>
								<td class="td-status"><span
									class="label label-success radius">失败</span></td>
								<td>支付失败</td>
								<td><a title="订单详细" href="order_detailed.html"
									class="btn btn-xs btn-info order_detailed"><i
										class="fa fa-list bigger-120"></i></a> <a title="删除"
