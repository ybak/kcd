				...
				<div id="menu_style" class="menu_style">
					<ul class="nav nav-list" id="nav_list">
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/selectAllClient.do" title="会员列表" class="iframeurl"><i
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								...
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/administrator.jsp" title="管理员列表" class="iframeurl"><i
