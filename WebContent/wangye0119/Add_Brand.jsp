...
<meta name="renderer" content="webkit|ie-comp|ie-stand">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
		...
		<link href="${pageContext.request.contextPath}/wangye0119/Widget/icheck/icheck.css" rel="stylesheet" type="text/css" />
		<!--[if IE 7]>
				...
				<ul class="add_conent">
					...
					<li class=" clearfix"><label class="label_name">品牌图片：</label>
						<div class="demo l_f">
							<div class="logobox">
								<div class="resizebox">
									<img src="${pageContext.request.contextPath}/wangye0119/images/image.png" width="100px" alt="" height="100px" />
								</div>
							</div>
