...
<link href="${pageContext.request.contextPath}/wangye0119/assets/css/codemirror.css" rel="stylesheet">
	...
	<link rel="stylesheet"
		href="${pageContext.request.contextPath}/wangye0119/Widget/zTree/css/zTreeStyle/zTreeStyle.css" type="text/css">
...
<![endif]-->
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/wangye0119/Widget/zTree/js/jquery.ztree.all-3.5.min.js"></script>
	...
	<div class=" clearfix">
		<div id="category">
			...
			<iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0
				SCROLLING=AUTO SRC="product-category-add.jsp"
