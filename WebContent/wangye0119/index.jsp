...
<!--[if lte IE 8]>
		...
		<![endif]-->
<script src="${pageContext.request.contextPath}/wangye0119/assets/js/ace-elements.min.js"></script>
<script src="${pageContext.request.contextPath}/wangye0119/assets/js/ace.min.js"></script>
...
<script src="${pageContext.request.contextPath}/wangye0119/js/jquery.nicescroll.js" type="text/javascript"></script>
...
$('.change_Password').on('click', function(){
  ...
  $('#Exit_system').on('click', function(){
	...
	function(){
	  location.href="${pageContext.request.contextPath}/bmsLoginOut.do";
    });
});
});
...
<body>
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand"> <small> <img
						src="${pageContext.request.contextPath}/wangye0119/images/kcd.png" width="470px">
				</small>
				</a>
				<!-- /.brand -->
			</div>
				...
				<ul class="nav ace-nav">
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <span class="time"><em   
								id="time"></em></span><span class="user-info"><small>欢迎光临,</small>${sessionScope.bms_uname}</span>
							<i class="icon-caret-down"></i>
					</a>
						<ul
							class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							<li><a href="javascript:void(0" name="${pageContext.request.contextPath}/wangye0119/Systems.jsp"
								title="系统设置" class="iframeurl"><i class="icon-cog"></i>网站设置</a></li>
							<li><a href="javascript:void(0)" name="${pageContext.request.contextPath}/wangye0119/admin_info.jsp"
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<div id="menu_style" class="menu_style">
					<ul class="nav nav-list" id="nav_list">
						<li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath}/wangye0119/home.jsp"
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Products_List.jsp" title="产品类表" class="iframeurl"><i
										class="icon-double-angle-right"></i>产品类表</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Brand_Manage.jsp" title="品牌管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>品牌管理</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Category_Manage.jsp" title="分类管理" class="iframeurl"><i
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/advertising.jsp" title="广告管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>广告管理</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Sort_ads.jsp" title="分类管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>分类管理</a></li>
							</ul></li>
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/transaction.jsp" title="交易信息" class="iframeurl"><i
										class="icon-double-angle-right"></i>交易信息</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Order_Chart.jsp" title="交易订单（图）" class="iframeurl"><i
										class="icon-double-angle-right"></i>交易订单(图)</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Orderform.jsp" title="订单管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>订单管理</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Amounts.jsp" title="交易金额" class="iframeurl"><i
										class="icon-double-angle-right"></i>交易金额</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Order_handling.jsp" title="订单处理" class="iframeurl"><i
										class="icon-double-angle-right"></i>订单处理</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Refund.jsp" title="退款管理" class="iframeurl"><i
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Cover_management.jsp" title="账户管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>账户管理</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/payment_method.jsp" title="支付方式" class="iframeurl"><i
										class="icon-double-angle-right"></i>支付方式</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Payment_Configure.jsp" title="支付配置" class="iframeurl"><i
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/selectAllClient.do" title="客户列表" class="iframeurl"><i
										class="icon-double-angle-right"></i>客户列表</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/member-Grading.jsp" title="等级管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>等级管理</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/integration.jsp" title="会员记录管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>客户记录管理</a></li>
							</ul></li>
						<li><a href="#" class="dropdown-toggle"><i
								class="icon-laptop"></i><span class="menu-text"> 团队管理 </span><b
								class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/selectLoginUserTeam.do?upid=${sessionScope.bms_id}" title="团队列表" class="iframeurl"><i
										class="icon-double-angle-right"></i>团队列表</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Shops_Audit.jsp" title="店铺审核" class="iframeurl"><i
										class="icon-double-angle-right"></i>团队审核<span
										class="badge badge-danger">321</span></a></li>
							</ul></li>
						<li><a href="#" class="dropdown-toggle"><i class="icon-comments-alt"></i>
									<span class="menu-text">消息管理 
										<span class="badge badge-danger">21</span>
									</span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Guestbook.jsp" title="留言列表" class="iframeurl"><i
										class="icon-double-angle-right"></i>留言列表</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Feedback.jsp" title="意见反馈" class="iframeurl"><i
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/article_list.jsp" title="文章列表" class="iframeurl"><i
										class="icon-double-angle-right"></i>文章列表</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/article_Sort.jsp" title="分类管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>分类管理</a></li>
							</ul></li>
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/Systems.jsp" title="系统设置" class="iframeurl"><i
										class="icon-double-angle-right"></i>系统设置</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/System_section.jsp" title="系统栏目管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>系统栏目管理</a></li>

								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/System_Logs.jsp" title="系统日志" class="iframeurl"><i
										class="icon-double-angle-right"></i>系统日志</a></li>
							</ul></li>
						<li><a href="#" class="dropdown-toggle"><i class="icon-group"></i>
								<span class="menu-text">管理员管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">

								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/admin_Competence.jsp" title="权限管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>权限管理</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/selectAllUser.do" title="管理员列表" class="iframeurl"><i
										class="icon-double-angle-right"></i>管理员列表</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/wangye0119/admin_info.jsp" title="个人信息" class="iframeurl"><i
           ...
           $("#menu_style").niceScroll({  
			...
			<div class="main-content">
				<script type="text/javascript">
							try{ace.settings.check('s' , 'fixed')}catch(e){}
						</script>
				...
				<iframe id="iframe"
					...
					name="iframe" frameborder="0" src="${pageContext.request.contextPath}/wangye0119/home.jsp"> </iframe>
	...
	<div class="footer_style" id="footerstyle">
		...
		<p class="l_f">版权所有： 福建快车道网络科技有限公司</p>
		<p class="r_f">地址：上海浦东新区国展路189号博大汽车公园明日世界  技术支持：快车道技术部</p>
	</div>
	<!--修改密码样式-->
