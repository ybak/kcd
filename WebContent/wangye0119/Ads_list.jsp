...
<meta name="renderer" content="webkit|ie-comp|ie-stand">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
		...
		<link href="${pageContext.request.contextPath}/wangye0119/assets/css/codemirror.css" rel="stylesheet">
			<link rel="stylesheet" href="${pageContext.request.contextPath}/wangye0119/assets/css/colorbox.css">
				<!--图片相册-->
		...
		<![endif]-->
				...
				<script src="${pageContext.request.contextPath}/wangye0119/assets/js/jquery.colorbox-min.js"></script>
				...
				<script type="text/javascript" src="${pageContext.request.contextPath}/wangye0119/Widget/swfupload/swfupload.js"></script>
				<script type="text/javascript"
					src="${pageContext.request.contextPath}/wangye0119/Widget/swfupload/swfupload.queue.js"></script>
				<script type="text/javascript"
					src="${pageContext.request.contextPath}/wangye0119/Widget/swfupload/swfupload.speed.js"></script>
				<script type="text/javascript" src="${pageContext.request.contextPath}/wangye0119/Widget/swfupload/handlers.js"></script>
					...
					<tbody>
						<tr>
							...
							<td><input name="" type="text" style="width: 50px"
								placeholder="1" /></td>
							<td><span class="ad_img"><a href="products/ad.jpg"
									data-rel="colorbox" data-title="广告图"><img
										src="products/ad.jpg" width="100%" height="100%" /></a></span></td>
							<td>1890x1080</td>
						...
						<tr>
							...
							<td><input name="" type="text" style="width: 50px"
								placeholder="2" /></td>
							<td><span class="ad_img"><a href="products/p_42.jpg"
									data-rel="colorbox" data-title="广告图"><img
