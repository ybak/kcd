...
//
//public class disbursement extends BaseJunit4Test {
//
//    /**
//     * 浠ost鏂瑰紡璁块棶
//     * 
...
//        
//        
//        data.put("disbursementInfo", list);
//        // 鍏堣皟鐢ㄥ悓姝ュ�熸浜烘帴鍙�
...
//            @Override
//            public void run() {
//                post("http://localhost:8080/services/rest/loan/disbursement", aa);
//            }
//        });
//    }
//    private static Object addBankInfo2() {
//        JSONObject oneBank = new JSONObject();
//        oneBank.put("bankName", "鍗庡閾惰2");// 閾惰鍚嶇О bank
//        oneBank.put("bankBranchName", "鏀2");// String 鍒嗚/寮�鎴疯鍚嶇О name
//        oneBank.put("accountNo", "abc2");// String 閾惰璐﹀彿 cardunm
//        return oneBank;
//    }
...
//        one.put("disbursementPayType","2");//鏀粯鏂瑰紡
//        // 0:绗笁鏂规敮浠樺钩鍙�,
//        //1:鐜伴噾,2:閾惰杞处,
//        //3:搴旀敹绁ㄦ嵁,4:鍊烘潈杞
//
//        one.put("disbursementAmount","2000"); 
//        one.put("disbursementDate","20170909000000"); 
//        one.put("disbursementBank",addBankInfo2()); 
//        
//        return one;
//    }
//
