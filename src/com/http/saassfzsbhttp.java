...
//		protected $pwd = 'qIMwArUHEMjjGjjtoJyHctuLiThJWz';
	...
	public static final String username="8f0854fe-9fc1-4fec-a68a-91aa9e37c8a0";//替换OCR SDK开发者平台API帐号
	public static final String password="qIMwArUHEMjjGjjtoJyHctuLiThJWz";//替换OCR SDK开发者平台API密码
	...
	private static String getSendXML(String action,String ext) {
		...
		arr.add(new String[] { "header","0" });//返回头像图片流，默认为0不需要，1：需要头像文件流
