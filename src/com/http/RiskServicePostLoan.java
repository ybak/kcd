...
//贷后
public class RiskServicePostLoan {
 
    private static final Log log = LogFactory.getLog(RiskServicePostLoan.class);
    ...
    public static void main(String[] args) {
        ...
        JSONObject riskResp = new RiskServicePostLoan().invoke(params);
