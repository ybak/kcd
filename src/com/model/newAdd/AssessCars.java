...
public class AssessCars{
	...
	private String mem_states;
	private String mem_citys;
	private int brid;
	private int seid;
	private String carid;
	private String car_days;
	private int car_km;
	private String color_id;
	private int price_new;
	private float model_score;
	private float parts_score;
	private float gaso_score;    //  与  bmnuser表 中 uid 关联
	private float color_score;
	private float items_score;
	private float hide_score;
	private float score;
	...
	private String cbs_orderid;
	private String cbs_result;
	private int qryid_bx;
	private int qryid_by;
	private int qryid_qryid;
	private int orderid;
	public int getId() {
		return id;
	}
	...
	public String getMem_states() {
		return mem_states;
	}
	public void setMem_states(String mem_states) {
		this.mem_states = mem_states;
	}
	public String getMem_citys() {
		return mem_citys;
	}
	public void setMem_citys(String mem_citys) {
