...
import cn.jpush.api.JPushClient;   
    ...
    public class Jdpush {  
        ...
        public static void testSendPush(String appKey ,String masterSecret,String REGISTRATION_ID,String content) {  
            ...
            //PushPayload payload = buildPushObject_all_all_alert();  
             //生成推送的内容，这里我们先测试全部推送  
            PushPayload payload=buildPushObject_all_alias_alert(REGISTRATION_ID,content);  
            try {  
        ...
        public static PushPayload buildPushObject_all_alias_alert( String REGISTRATION_ID,String alert) {  
            return PushPayload.newBuilder()  
                    .setPlatform(Platform.all())//设置接受的平台  
                    .setAudience(Audience.registrationId(REGISTRATION_ID))//Audience设置为all，说明采用广播方式推送，所有用户都可以接收到  
        ...
        public static void main(String[] args) {			
        	 //Jdpush.testSendPush(appKey,masterSecret,"是的反腐"); 
        	//System.out.println("");
		}
    }  