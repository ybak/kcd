...
public class erp_wdrw_2Controller {
	...
	public String wdrw_list_up(
		...
		pd1_count.put("c_name",new String(c_name.getBytes("ISO-8859-1"),"UTF-8"));
		...
		if(pd1_count_map!=null&&!pd1_count_map.equals("")) {
			if(pd1_count_map.get("totalsize")!=null&&!pd1_count_map.get("totalsize").equals("")) {
				totalsize=Integer.parseInt(pd1_count_map.get("totalsize").toString());
			}
		}
		if (q == 0) {
