...
private boolean	zx_mbg;
private String	mg_tag;
...
public boolean isZx_mbg() {
	return zx_mbg;
}
public void setZx_mbg(boolean zx_mbg) {
	this.zx_mbg = zx_mbg;
}
public String getMg_tag() {
	return mg_tag;
}
public void setMg_tag(String mg_tag) {
	this.mg_tag = mg_tag;
}
