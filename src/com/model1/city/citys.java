...
public class citys {
	...
	private int pact_num;
	private int pact_price;
	...
	public String getChrkey() {
		return chrkey;
	}
	public void setChrkey(String chrkey) {
		this.chrkey = chrkey;
	}
	...
	public void setVips_num(int vips_num) {
		this.vips_num = vips_num;
	}
	...
	public int getPact_price() {
		return pact_price;
	}
	public void setPact_price(int pact_price) {
		this.pact_price = pact_price;
	}
