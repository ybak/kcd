package com.mapper1.TrailernotAccepted;
...
public interface TrailernotAcceptedMapper {
	 ...
	 * @return
	 */
	List<PageData> selectTrailernotAccepted(@Param(value="param") String param,@Param("pagenow")int pagenow,@Param("pagesize")int pagesize,@Param("fsid")int fsid,@Param("fs_id")int fs_id);
	/**
	 * 查询总条数
	 */
	int count();
	 ...
	 * @return
	 */
	List<PageData> selectTrailernotAccepted1(@Param(value="param") String param,@Param("pagenow")int pagenow,@Param("pagesize")int pagesize,@Param("fsid")int fsid,@Param("fs_id")int fs_id);
	/**
	 * 查询总条数
	 */
	int count1();
	 ...
	 * @return
	 */
	List<PageData> selectTrailernotAccepted2(@Param(value="param") String param,@Param("pagenow")int pagenow,@Param("pagesize")int pagesize,@Param("fsid")int fsid,@Param("fs_id")int fs_id);
	/**
	 * 查询总条数
	 */
	int count2();
